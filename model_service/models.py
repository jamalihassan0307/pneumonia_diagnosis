...
class ModelVersion(models.Model):
    ...
    input_size = models.CharField(max_length=20, default='224x224')  # e.g., "224x224"
...
class ProcessingLog(models.Model):
    ...
    execution_time = models.DecimalField(max_digits=8, decimal_places=3, null=True)  # in seconds
    created_at = models.DateTimeField(auto_now_add=True)
